%
% claude-sdk-specification.tex
% Compile: pdflatex claude-sdk-specification.tex
%
...
\title{Claude SDK for Pharo:\\Technical Specification}
\author{Punt Labs}
\date{April 2026 --- v0.3.0-dev}
\hypersetup{
  pdftitle={Claude SDK for Pharo: Technical Specification},
  pdfauthor={Punt Labs},
  pdfsubject={Claude SDK Specification},
  pdfcreator={pdflatex}
}
\maketitle
...
\texttt{claude-sdk-specification-gap-analysis.md}.  Pharo-specific
implementation notes live in
\emph{claude-sdk-specification-pharo-notes.tex}.  The Agent layer
...
The Claude SDK for Pharo is a Smalltalk client for
...
document \emph{Claude SDK for Pharo: Pharo-Specific

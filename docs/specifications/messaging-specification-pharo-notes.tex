%
% messaging-specification-pharo-notes.tex
% Compile: pdflatex messaging-specification-pharo-notes.tex
%
...
\title{Claude Messaging SDK for Pharo:\\Pharo-Specific Implementation Notes}
\author{Punt Labs}
\date{April 2026 --- v0.3.0-dev}
\hypersetup{
  pdftitle={Claude Messaging SDK for Pharo: Pharo-Specific Implementation Notes},
  pdfauthor={Punt Labs},
  pdfsubject={Messaging SDK Pharo-Specific Notes},
  pdfcreator={pdflatex}
}
\maketitle
...
to \emph{messaging-specification.tex}.
